        ...
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                ...
                <div class="dropdown profile-element">
                    <span><img alt="image" class="img-circle" src="{{asset('assets/image/profile_small.jpg')}}"/></span>
                    ...
                    {{--</li>--}}
                    {{--<li class="divider"></li>--}}
                    {{--<li><a href="../auth/login.html">安全退出</a>--}}
                    {{--</li>--}}
                    {{--</ul>--}}
                </div>
            ...
            <li data-active-route="/" class="active">
            ...
            <li data-active-route="/admin/banner">
                <a href="{{route('banner')}}"><i class="fa fa-th-large"></i> <span class="nav-label">banner管理</span> </a>
            </li>
            <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="../auth/login.html">登录</a>
                    </li>
            ...
            <li>
                <a href="index.html#"><i class="fa fa-cutlery"></i> <span class="nav-label">工具 </span><span
                        class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
