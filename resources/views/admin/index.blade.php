                ...
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <span class="m-r-sm text-muted welcome-message"><a href="index.html" title="返回首页"><i
                                    class="fa fa-home"></i></a>{{ config('app.name', 'Laravel') }}</span>
                        </li>
                        <li>
                            <a href="{{route('logout')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        <p>如果需要购买H+主题，可直接付款到支付宝：<a href="http://www.zi-han.net/theme/hplus/javascript;">zheng-zihan@qq.com</a>，收款人：<a
                                                href="http://www.zi-han.net/theme/hplus/javascript;">*子涵</a>。或者使用手机支付宝直接扫码支付：
                                        </p>
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        <p><i class="fa fa-send-o"></i> 博客：<a href="http://www.zi-han.net"
                                                                              target="_blank">http://www.zi-han.net</a>
                                        </p>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div id="v21" class="panel-collapse collapse">
                                                        <div class="panel-body">
                                                            <ol>
                                                                <li>
                                                                    增加cdn服务支持，cdn节点使用阿里云服务，可保证您的项目随时使用最新版本的H+，免去反复升级的麻烦；</a>
                                                                </li>
                                                                <li>修复一些问题；</li>
                                                            </ol>
                                                        </div>
                                                    ...
                                                    <div id="v20" class="panel-collapse collapse">
                                                        <div class="panel-body">
                                                            <ol>
                                                                ...
                                                                <li>增加<a
                                                                        href="toastr_notifications.html">Toastr通知</a>、<a
